...
const CONSTR_DATA = {
    1: {
        ...
        cost: function() {
            ...
            if (player.construction[this.tier].gte(25)) { c = c.times(Decimal.pow(hasTUpgrade(33) ? this.expCostMult*getTUpgEffect(33) : this.expCostMult, addFactorial(player.construction[this.tier].minus(24)))); }
            return c;
        },
        baseCostMult: 5,
        expCostMult: 10,
